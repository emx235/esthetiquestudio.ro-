			...
			<div class="row">
				<div class="col-xs-12 col-sm-5 col-md-4 col-md-offset-1 mb-30 wow fadeIn">
					<div class="contact-details mt-50">
						...
						<ul class="pl-20 list-unstyled">
							<li>Luni – Vineri: 10:00 – 14:00  și 16:00 – 20:00</li>
						</ul>
					</div>
				</div>
...
<div class="container" style="margin-top: 0; padding-top: 0;">
  <h4>Ne găsești pe Strada Lămâiței nr. 37, Brașov</h4>
  <div class="mapouter" style="position:relative;text-align:right;height:400px;width:100%;">
    <div class="gmap_canvas" style="overflow:hidden;background:none!important;height:400px;width:100%;">
      <iframe 
        ...
        height="400" 
        id="gmap_canvas"
        src="https://maps.google.com/maps?q=Strada%20Lămâiței%2037%2C%20Brașov&hl=ro&z=17&output=embed"
        frameborder="0" 
        scrolling="no" 
        marginheight="0" 
        marginwidth="0"
...
(function(){
  ...
  // contact-cosmetica
  attachSmartWA('wa-btn-cosmetica', 'contact-form', 'Cosmetică');
})();
</script>
